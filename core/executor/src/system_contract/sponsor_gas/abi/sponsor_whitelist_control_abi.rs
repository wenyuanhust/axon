...
pub mod sponsor_whitelist_control {
    ...
    pub struct AddPrivilegeCall(pub ::std::vec::Vec<ethers::core::types::Address>);
    ...
    pub struct RemovePrivilegeCall(pub ::std::vec::Vec<ethers::core::types::Address>);
